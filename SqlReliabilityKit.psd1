@{
    ...
    PrivateData = @{
        PSData = @{
            ...
            ReleaseNotes = '0.2.0 - Adds Test-SqlRestoreChain (backup chain validation with logical and physical/DBCC modes). 0.1.0 - Find-SqlQueryStoreRegression (execution-weighted Query Store regression detection).'
        }
    }
}
