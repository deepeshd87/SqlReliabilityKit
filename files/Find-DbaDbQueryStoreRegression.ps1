...
FROM current_perf c
JOIN baseline b ON c.query_id = b.query_id AND c.plan_id = b.plan_id
        ...
        foreach ($instance in $SqlInstance) {
            ...
            foreach ($db in $dbs) {
                ...
                foreach ($row in $results) {
                    ...
                    } | Select-DefaultView -Property SqlInstance, Database, QueryId, PlanId, BaselineDurationMs, CurrentDurationMs, SlowdownFactor, CurrentExecCount
                }
            }
        }
    }
